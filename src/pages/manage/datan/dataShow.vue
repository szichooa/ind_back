	...
	<div class="content-views">
		<div class="content-views-nav">
			...
			<div class="mbanav-r">
				<el-breadcrumb separator-class="el-icon-arrow-right">
					...
					<el-breadcrumb-item :to="{ path: '/data' }">计算数据库</el-breadcrumb-item>
		...
		<div class="content-views-body">
			<el-table ref="multipleTable"
				...
				<el-table-column prop="create_time" label="计算时间" sortable width="220">
					<template slot-scope="scope">{{ scope.row.create_time }}</template>
				</el-table-column>
				<el-table-column prop="user_name" label="用户名字" width="150">
				</el-table-column>
				<el-table-column v-for="item,index in inputData" :prop="'result_table.'+index+'.'+item.key" :label="item.key" :key="item.key">
				</el-table-column>
			</el-table>			
		</div>
		<div class="content-view-bottom">				
			...
			<div class="btn-left-bottom">
				<el-button size="small" @click="showAlertNow" type="primary">数据分析</el-button>
			...
			<h4>选择参数数据</h4>
				<el-form ref="" label-width="80px" class="add-addOpeForm-form demo-addOpeForm" size="small">
					<el-form-item label-width="0px" class="add-model-form-btn">
						<el-select v-model="attrs" multiple placeholder="请选择或输入查询数据" style="width:280px;" filterable>
							<el-option
...
import {getResultDBData,delResultDBData,getDataBind,getResultDBDataCom} from '../../../api/api';
	export default{
		components: {
			tableShow
		},
